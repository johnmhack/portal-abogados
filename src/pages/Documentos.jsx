...
const styles = {
  ...
  tablaHeader: { display: 'grid', gridTemplateColumns: '2fr 1.5fr 1fr 120px', padding: '12px 20px', backgroundColor: '#f8f9fa', fontSize: '12px', fontWeight: '600', color: '#b2bec3', textTransform: 'uppercase' },
  tablaFila: { display: 'grid', gridTemplateColumns: '2fr 1.5fr 1fr 120px', padding: '16px 20px', borderTop: '1px solid #f0f2f5', alignItems: 'center' },
